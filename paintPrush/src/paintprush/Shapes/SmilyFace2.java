...
public class SmilyFace2 extends Shape {
...
//        g.fillOval(x, y, h, h);
        ...
        g.drawLine(x + (h / 6), y + ((2 * h) / 3), x + (h - (h / 6)), y + ((2 * h) / 3));
        g2.setStroke(new BasicStroke(getStroke()));
...
//        }
    ...
    public String toSVG() {
        ...
        int h = Math.abs(getP1().y - getP2().y);
        String svgString = "";
        svgString = String.format("<circle class=\"smilyFace2\" width=\"%d\" height=\"%d\" cx=\"%d\" cy=\"%d\" r=\"%d\"   fill=\"none\" stroke-width=\"%d\" stroke=\"%s\"/>",
    ...
    public static Shape loadSVG(org.w3c.dom.Node node) {
        SmilyFace2 smilyFace2 = new SmilyFace2();
        ...
        smilyFace2.getP1().x = Integer.parseInt(cxNode.getNodeValue()) - Integer.parseInt(r.getNodeValue());
        smilyFace2.getP1().y = Integer.parseInt(cyNode.getNodeValue()) - Integer.parseInt(r.getNodeValue());
        smilyFace2.getP2().x = Integer.parseInt(cxNode.getNodeValue()) + Integer.parseInt(r.getNodeValue());
        smilyFace2.getP2().y = Integer.parseInt(cyNode.getNodeValue()) + Integer.parseInt(r.getNodeValue());

        if (stroke_width != null && stroke_width.getNodeValue() != null) {
            smilyFace2.strokeColor = Color.decode(stroke.getNodeValue());
            smilyFace2.stroke = Integer.parseInt(stroke_width.getNodeValue());
        } else {
            smilyFace2.nonStroke = true;
        }
